    ...
    while not client.is_closed():
        try:
            ...
            if (current_time - video_time) <= timedelta(days=1) and video_id not in sent_videos:
                sent_videos.append(video_id)  # Add video to sent list
                save_sent_videos(sent_videos)  # Save updated list

                # Create Embed Message
                embed = discord.Embed(
                    title="🌅☕️☕️🥐🍨⚘️ 🌅☕️☕️🥐🍨⚘️ Guten sonnigen Morgen Schwarzen Peter  und  Deutschland!🇩🇪🇩🇪🇩🇪🇩🇪💐❤️💐❤️💐❤️💐❤️💐❤️ Herzliches  DANKESCHÖN  Schwarzen Peter für  ein  SUPER!  SUPER!  SUPER  FABELHAFT  💥🖤🤍❤️💫 Marschlied!!!🎉🎉🎺🥁🎺🥁🎶🎶🎶🎶🎶💜 🌟🌟🌟🌟🌟 Sehr  GROSSARTIGES  Video!!!🎶💎💎💎💎🎵🎶🎶💐🎆💐🎆💐✨️💞💞Ich  wünsche  Sie  einen  sehr  wundervollen  {days_of_weekp[time.weekday()]:12q! 🍻🥨🍻🇩🇪🇩🇪🇩🇪🇩🇪🏔️🎺🥁🎵🎶🎶❤️🤗🥰",
...
async def on_message(message):
    ...
    if "ludwig" in content_lower and not message.author.bot:
        await message.channel.send(f"🍃📯🦅🖤🤍❤️📯📯📯🎺🥁 Das ist ein FANTASTISCHER AUSGEZEICHNETESTE SCHÖNSTE 💪❣️💪🍃🌊 Marsch!!!!🎺💐☕️💖 Guten Morgen lieber Dr.Ludwig und sehr wunderschönen {days_of_week[datetime.datetime.today().weekday()-1]}!!!❤️❤️❤️❤️❤️❤️❤️❤️ Großes Herzliches DANKESCHÖN für ein SUPERRRRR WUNDERBARES Marsch und TOLLES Bild!!!.....🥰Ich bin BEGEISTERT!!!🌟......👌🥂🥂🎉💖💋💋🤗")
